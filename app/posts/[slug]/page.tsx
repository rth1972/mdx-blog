...
const { slug } = await params;
  ...
  const postUrl = `https://blog.robintehofstee.com/posts/${post.slug}`;
        ...
        <article>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-12">
            ...
            <a
              ...
              className="flex-1 px-6 py-4 bg-titans-red text-white rounded-lg hover:bg-titans-accent transition-colors text-center font-semibold shadow-lg hover:shadow-xl"
            >
              Get in touch
            </a>
          </div>
